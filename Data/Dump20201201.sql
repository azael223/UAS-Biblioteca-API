...
--
-- Dumping data for table `usuarios_auth`
--

LOCK TABLES `usuarios_auth` WRITE;
/*!40000 ALTER TABLE `usuarios_auth` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuarios_auth` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-12-01  0:17:01
